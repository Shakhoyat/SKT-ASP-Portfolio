...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="section" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
        <div class="container">
            <div class="text-center">
                <h1 class="section-title" style="color: white; margin-bottom: 1rem;">My Projects</h1>
    ...
    <div class="section" style="background-color: #f8f9fa; padding: 2rem 0;">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                        ...
                        <div class="col-md-6 mb-4 project-item" data-category="web">
                            <div class="project-card">
                                <div class="project-image">
                                    <img src="<%# Eval("DisplayImageUrl") %>" alt="<%# Eval("Title") %>" />
                                    <div class="project-overlay">
                                        <div class="project-links">
                                            <%# !string.IsNullOrEmpty(Eval("ProjectUrl").ToString()) ? 
                                                "<a href='" + Eval("ProjectUrl") + "' target='_blank' class='btn btn-primary' title='View Live Demo'><i class='fas fa-external-link-alt'></i> Live Demo</a>" : "" %>
                                            <%# !string.IsNullOrEmpty(Eval("GitHubUrl").ToString()) ? 
                                                "<a href='" + Eval("GitHubUrl") + "' target='_blank' class='btn btn-secondary' title='View Source Code'><i class='fab fa-github'></i> Source</a>" : "" %>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="project-content">
                                    ...
                                    <div class="project-technologies">
                                        <asp:Repeater ID="rptTechnologies" runat="server" DataSource='<%# Eval("TechnologiesList") %>'>
                                            <ItemTemplate>
        ...
        <div class="container">
            ...
            <div class="technologies-grid">
                <div class="tech-category">
                    <h4><i class="fas fa-code" style="color: #007bff;"></i> Frontend</h4>
                ...
                <div class="tech-category">
                    <h4><i class="fas fa-server" style="color: #28a745;"></i> Backend</h4>
                    <div class="tech-items">
                ...
                <div class="tech-category">
                    <h4><i class="fas fa-database" style="color: #ffc107;"></i> Database</h4>
                    <div class="tech-items">
                ...
                <div class="tech-category">
                    <h4><i class="fas fa-tools" style="color: #dc3545;"></i> Tools</h4>
                    <div class="tech-items">
